  ...
  <header>
    ...
    <div class="navbar-nav navbar-links">
      <div id="sino">
        ...
        <div id="contador_notificacao">
        </div>
      </div>
      <a class="nav-item nav-link" href="../motorista/inicio.php">Início</a>
      <a class="nav-item nav-link" href="../motorista/perfil.php">Perfil</a>
      <a class="nav-item nav-link" href="../motorista/historico.php">Histórico</a>
      <a class="nav-item nav-link" href="../motorista/sobre.php">Sobre e Ajuda</a>
