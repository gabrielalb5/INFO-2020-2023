        ...
        <form action="../src/recupera_login.php" method="post">
          <div id="opcao_login">
            ...
            <div class="textfield">
                ...
                <input class="form-control" type="password" placeholder="Senha" id="id_senha" name="senha" required><span class="material-symbols-outlined" id="olho" onclick="ver_senha()">visibility_off</span></br>
