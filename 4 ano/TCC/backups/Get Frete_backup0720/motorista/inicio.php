...
<div class="container">
    ...
    <?php
        if($contador_v==0){
            ...
            echo '<h4>Pedidos disponíveis</h4></div>';
            echo '<div id="pedidos">';
            $i = 0;
            ...
            ?>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modalpropostaLabel">Detalhes do pedido</h1>
                    ...
                    <input type="number" placeholder="Proponha uma oferta" id="valor" name="valor" min="0" step=".01" required></br>
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" class="btn btn-primary" value="Fazer proposta">
                    </div>
                    </div>
                    </form>
                </div>
