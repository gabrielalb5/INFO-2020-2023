...
<div class="container">
    <div class="cabecalho">
        <div class="row">
            ...
            <p><span class="material-symbols-outlined" data-toggle="tooltip" data-placement="bottom" title="Avaliação com base nas suas entregas">magic_button</span> <?php echo $usuario["avaliacao"] ?></p>
            </div>
            <div class="col-md-auto">
            <h4>Veículos</h4>
            <?php
        ...
        if($contador_v==0){
            ...
            <h4><span class="material-symbols-outlined">calendar_month</span> Entregas agendadas</h4>
                ...
                if (empty($lista_pedidos_conf)) { 
                    ...
                    foreach ($lista_pedidos_conf as $pedido) {
                        ...
                        ?>
                        <div id="card_agenda">
                            <h6><?php formataData($data); ?> às <?php formataHora($hora)?>h</h6>
            ...
            ?>
                <div id="card_pedido" class="col-6">
                    ...
                    <p>Retirada: <?php echo $proposta["origem"]; ?></p>
                    <p>Entrega: <?php echo $proposta["destino"]; ?></p>
                    <p><span class="material-symbols-outlined">calendar_month</span> <?php formataData($data); ?> às <?php formataHora($hora)?>h</p>
