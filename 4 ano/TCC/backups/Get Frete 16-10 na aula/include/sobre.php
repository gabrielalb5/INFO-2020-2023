...
<div id="container">
    ...
    <div id="accordion">
        ...
        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
            <div class="card-body">
            <p>Para a utilização do sistema é necessário realizar o <a href="../public/cadastro.php">cadastro</a>. Você pode escolher entre
            ...
            <p>É necessário preencher todos os dados solicitados antes de prosseguir e ao 
                finalizar o cadastro você poderá <a href="../public/cadastro.php">acessar seu perfil</a> e explorar o Get Frete.</p>
            </div>
        </div>
        </div>
