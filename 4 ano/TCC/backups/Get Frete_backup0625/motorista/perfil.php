...
<div class="container">
    <div class="cabecalho">
        <div class="row">
            ...
            <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editar">Editar perfil</button>
            </div>
            <div class="col-md-auto">
            <h4>Veículos</h4>
            <?php
                if($contador_v==0){ 
                    ...
                    <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#veiculo_add">Adicionar veículo</button>';
                }else{
                    ...
                    echo '</ul>';
                    if($contador_v<3){
                        echo '<button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#veiculo_add">Adicionar veículo</button>
                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#veiculo_edit">Editar veículos</button>';
                    }else{
                        echo '<button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#veiculo_edit">Editar veículos</button>';
                    }
                }
            ?>
            </div>
            ...
            <?php foreach($lista_veiculos as $veiculo):?>
                ...
                <form action="editar_veiculo.php" method="post">
                    ...
                    <span class="d-inline-block" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Disabled popover">
                        <div class="textfield">
                            <label for="renavam">Renavam</label>
                            <input value="<?php echo $veiculo["renavam"]?>" type="text" pattern="[0-9]*" title="Apenas números são permitidos" placeholder="Digite o Código" id="renavam" name="renavam" min="0" maxlength="11" disabled required>
                    ...
                    <div id="col2">
                        <div class="textfield">
                            <label for="placa">Placa</label>
                            <input value="<?php echo $veiculo["placa"]?>" type="text" placeholder="Placa" id="placa" name="placa" maxlength="8" disabled required>
