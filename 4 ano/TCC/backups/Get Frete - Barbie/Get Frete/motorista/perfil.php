                ...
                <form action="cadastro_veiculo.php" method="post">
                    ...
                    <div id="col2">
                        <div class="textfield">
                            ...
                            <input type="text" placeholder="Placa" id="placa" name="placa" maxlength="8" oninput="converterMaiusculo()" required>
                        </div>
                        <div class="textfield">
    ...
    <?php
        if($contador_v==0){
            ...
            foreach ($lista_propostas_enviadas as $proposta) {
                $data = $proposta["data_entrega"];
                $hora = $proposta["horario"];
            ?>
                <div id="card_pedido" class="col-6">
                    ...
                    <p><span class="material-symbols-outlined">location_on</span> <?php echo $proposta["origem"]; ?></p>
                    <p><span class="material-symbols-outlined">arrow_forward</span> <?php echo $proposta["destino"]; ?></p>
                    ...
                    <form action="excluir_proposta.php" method="post">
                        <input type="hidden" name="id_p" value="<?php echo $proposta["id_p"]; ?>">
                        <button type="submit" class="btn btn-secondary" id="botao_largo"><span class="material-symbols-outlined">close</span> Cancelar proposta</button>
                    </form>
                </div>    
            <?php };
            echo '</div>';
