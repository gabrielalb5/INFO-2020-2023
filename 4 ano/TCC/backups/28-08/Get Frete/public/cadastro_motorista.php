    ...
    <div id="colunas">
        ...
        <div id="col2">
            <div class="textfield">
                ...
                <input type="password" placeholder="Senha" id="senha" name="senha" value="<?php if(isset($_SESSION["senha"])){echo $_SESSION["senha"];}; ?>" required><!--<span class="material-symbols-outlined" id="olho" onclick="ver_senha()">visibility_off</span>-->
            </div>
            <div class="textfield">
