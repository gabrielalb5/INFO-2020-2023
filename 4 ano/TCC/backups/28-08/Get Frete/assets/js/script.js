...
document.getElementById('btn_azul').addEventListener('submit', function(event) {
  event.preventDefault(); // Impede o envio do formulário para que possamos verificar as senhas primeiro
