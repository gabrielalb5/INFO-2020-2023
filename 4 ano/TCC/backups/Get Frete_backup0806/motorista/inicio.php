    ...
    <?php
        if($contador_v==0){
            ...
            <?php
                ...
                <p class="text-danger">Próxima entrega em <?php echo $diferenca_minutos; ?>min</p>
        ...
        if(empty($entrega_iniciada)){
            ...
            echo 'Entrega de '.$entrega_iniciada["cliente"].' já começou';
            echo $entrega_iniciada["descricao"];
            echo $entrega_iniciada["data_entrega"].' - '.$entrega_iniciada["horario"];
        };
        };?>
</div>
