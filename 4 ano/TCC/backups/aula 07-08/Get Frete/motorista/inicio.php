    ...
    <?php
        if($contador_v==0){
            ...
            if($diferenca_minutos<=0){?>
                <p class="text-danger">Entrega atrasada</p>
                <p class="text-danger"><?php echo formataData($proxima_entrega["data_entrega"]); ?> às <?php formataHora($proxima_entrega["horario"]) ?>h</p>
            <?php
            ...
            <?php
                ...
                <p class="text-secondary">Próxima entrega em <?php echo $diferenca_horas; ?>h</p>
                <p class="text-secondary"><?php echo formataData($proxima_entrega["data_entrega"]); ?> às <?php formataHora($proxima_entrega["horario"]) ?>h</p>
            <?php
            };?>
        ...
        if(empty($entrega_iniciada)){
            ...
            ?>
                <div id="card_pedido" class="col-6">
                    ...
                    <p>Retirada: <?php echo $pedido["origem"]; ?></p>
                    <p>Entrega: <?php echo $pedido["destino"]; ?></p>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <p class="text-secondary">Retirada: <?php echo $pedido["origem"]; ?></p>
                    <p class="text-secondary">Entrega: <?php echo $pedido["destino"]; ?></p>
        ...
        <div id="form_pedido">
            ...
            <p><?php echo formataData($entrega_iniciada["data_entrega"]); ?> às <?php formataHora($entrega_iniciada["horario"]) ?>h</p>
            ...
            <p id="destino_mapa" value="<?php echo $entrega_iniciada["destino"]; ?>"><span class="material-symbols-outlined">location_on</span> B - Entrega: <?php echo $entrega_iniciada["destino"]; ?></p>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Retirada: <?php echo $entrega_iniciada["origem"]; ?></p>
                    <p>Entrega: <?php echo $entrega_iniciada["destino"]; ?></p>
                    <p><span class="material-symbols-outlined">calendar_month</span> <?php formataData($entrega_iniciada["data_entrega"]); ?> às <?php formataHora($entrega_iniciada["horario"])?>h</p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>
                </div>
