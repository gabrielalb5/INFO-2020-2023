...
function listarProdutos() {
  $lista_produtos = [];
  $sql = "SELECT p.id_produto, p.descricao, p.valor, p.data_cadastro, c.descricao as descricao_categoria
          FROM Produto p
...
function inserirProduto($descricao, $valor, $data_cadastro, $categoria) {
  $conexao = obterConexao();
  $sql = "INSERT INTO Produto (descricao, valor, data_cadastro, id_categoria) 
                       VALUES ('$descricao', $valor, '$data_cadastro', $categoria)";
  $resultado = mysqli_query($conexao, $sql);
  if ($resultado) {
...
function alterarProduto($id_produto, $descricao, $valor, $data_cadastro, $categoria) {
  $conexao = obterConexao();
  $sql = "UPDATE Produto 
          SET descricao = '$descricao', valor = $valor, data_cadastro='$data_cadastro', id_categoria = $categoria
