    ...
    ?>
        <table class="table table-dark table-hover w-75">
            ...
            <tr>
                ...
                <td>
                    <a class="btn btn-warning" href="filme_form_ed.php?id_f=<?=$filme["id_f"]?>"><span class="material-symbols-outlined">edit</span></a>
                </td>
                <td>
                    <form action="filme_delete.php" method="post">
